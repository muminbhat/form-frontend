  ...
  return (
    <>
      ...
      <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        {failed ? (
          <div
            className="bg-red-500 text-sm text-white mb-5 rounded-md p-4"
            role="alert"
          >
            <span className="font-bold">Failed</span> Something Went Wrong. Please try again
          </div>
        ) : (
          <></>
        )}
            ...
            <div className="flex">
              ...
              <div className="ml-4">
                ...
                <div className="mt-2 text-sm text-gray-600">
                  We will get back to you within few hours. Please check your
